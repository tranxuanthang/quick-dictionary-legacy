...
function HtmlWhitelistedSanitizer(escape, tags, css, urls) {
  ...
  if (this.allowedTags == null) {
    ...
    this.allowedTags = {
	  ...
	  'source': HtmlWhitelistedSanitizer.mergeMap(globalAttributes, {
          'type': unconstrainted,
		  'data-width': unconstrainted,
		  'data-height': unconstrainted,
          'src': url_sanitizer
        }),
	  'audio': HtmlWhitelistedSanitizer.mergeMap(globalAttributes, {
          'id': unconstrainted,
		  'controls': unconstrainted,
      ...
      'i': globalAttributes,
      'u': globalAttributes,
	  'ul': HtmlWhitelistedSanitizer.mergeMap(globalAttributes, {
          'id': unconstrainted,
		  'class': unconstrainted
        }),
	  'li': HtmlWhitelistedSanitizer.mergeMap(globalAttributes, {
          'id': unconstrainted,
		  'class': unconstrainted
        }),
	  'ol': globalAttributes,
